    ...
    <>
      <PageContainer>
        <div className=" container_1">
          <h1 className="text-xl font-extrabold text-neutral-950 tracking-widest w-full flex justify-center my-[50px] md:text-7xl sm:text-4xl">
            Taste the Original <span className="text-green-700">KEBAB</span>{" "}
          </h1>
